        ...
        <el-row v-show="isOther">
          ...
          <div class="acea-row">
            <el-form-item label="赠送优惠券：" class="proCoupon">
              ...
              <el-button v-if="!isDisabled && !formValidate.coupons.length" size="small" class="mr15" @click="addCoupon"
                >选择优惠券</el-button
              >
...
export default {
  ...
  computed: {
    ...
    // 商品详情
    isInfo(){
      return (this.currentTab === '2' && this.formValidate.type !== this.OrderSecondTypeEnum.Reservation) || ( this.currentTab === '3' && this.formValidate.type === this.OrderSecondTypeEnum.Reservation)
    },
    // 其他设置
    isOther(){
      return (this.formValidate.type === this.OrderSecondTypeEnum.Reservation && this.currentTab === '4') || (this.formValidate.type !== this.OrderSecondTypeEnum.Reservation && this.currentTab === '3')
    },
    visitedViews() {
  ...
  methods: {
    ...
    getFromData() {
      ...
      // 可约日期星期范围，1~7 - 周一~周天
      if(this.formValidate.type === this.OrderSecondTypeEnum.Reservation) this.formValidate.supplementReservation.reservationDateWeekRange =
