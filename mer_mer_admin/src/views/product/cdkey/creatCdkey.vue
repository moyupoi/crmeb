  ...
  <div class="divBox">
    ...
    <el-card class="mt14" shadow="never" :bordered="false">
      <div class="acea-row mb20">
        ...
        <el-button size="small" v-if="checkPermi(['merchant:card:secret:batch:delete'])" @click="handleBatchDel"
          >批量删除</el-button
        >
      </div>
      <el-table
        ...
        <el-table-column label="操作" width="100" fixed="right">
          <template slot-scope="scope">
            <el-button
              ...
              v-if="checkPermi(['merchant:cdkey:update'])"
            ...
            <el-button
              type="text"
              v-if="checkPermi(['merchant:card:secret:delete'])"
              :disabled="!scope.row.isUse ? false : true"
